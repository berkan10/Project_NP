    ...
    while (1)
    {
        ...
        //parsing van gekozen pakket
            ...
            char* parsing2 = strtok(NULL,"<");
                ...
                stringToInt = atoi(parsing1);
                keuze_pakket = stringToInt;

               // printf("dit is de parsing : %i",keuze_pakket);
               ...
               // printf("%s\n",parsing);
                 ...
                 if(keuze_pakket == 1)
                 {
                  //   std::stringstream playerGold;
                     ...
                     strncat(buffer4,mes.c_str() ,strlen(mes.c_str()));
                ...
                else if(keuze_pakket == 2)
                 {
                   //  std::stringstream playerBrons;
                    ...
                    // std::string player_brons = playerBrons.str();
                     ...
                     strncpy(buffer5, pushanswerpackage, 22);
                     strncat(buffer5,mes1.c_str() ,strlen(mes1.c_str()));
                     zmq_send(pusher,buffer5, strlen(buffer5), 0);

                 }
                 else if(keuze_pakket == 3){
                     ...
                     strncpy(buffer6, pushanswerpackage, 22);
                     strncat(buffer6,mes2.c_str() ,strlen(mes2.c_str()));

                     zmq_send(pusher,buffer6, strlen(buffer6), 0);
                 }
